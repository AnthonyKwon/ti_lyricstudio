...
{
    public class AlbumArtBackgroundDrawOperation : ICustomDrawOperation
    {
        ...
        /// </param>
        public AlbumArtBackgroundDrawOperation(Rect bounds, SKBitmap? artwork, float time, float renderScale = 1f)
        {
            _bounds = bounds;
            _artwork = artwork;
            _time = time;
